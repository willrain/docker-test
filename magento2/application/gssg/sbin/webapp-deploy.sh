...
DOCKER_PRJ_HOME=/data01/docker/ssg-global-docker/magento2/application/magento2-gssg

PRJECT_NM=ssg-global-magento2
...
echo "
#--------------------------------------------------------------------------
# 3. magento2-gssg-webapp docker images 생성
#--------------------------------------------------------------------------"
cd ${WEBAPP_ROOT}
#docker rmi global-nexus:9003/magento2-gssg-webapp
docker build --force-rm=true -t global-nexus:9003/magento2-gssg-webapp .

echo "
#--------------------------------------------------------------------------
# 4. magento2-gssg-webapp docker images push
#--------------------------------------------------------------------------"
